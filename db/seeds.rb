...
Event.create({ name: "Denver Startup Week", date: "9/1/2019", category: "Conference Attendee", description: "Startup crawl", shared: 0, employee_ids: [4] })
Event.create({ name: "Lynda ES6 Course", date: "10/4/2019", category: "Online Course", description: "Functional programming basics", shared: 1, employee_ids: [5] })
Event.create({ name: "Pragmatic Programmer", date: "9/5/2019", category: "Book", description: "A riveting read", shared: 1, employee_ids: [6] })
...
Event.create({ name: "Graph QL 101", date: "10/8/2019", category: "In Person Course", description: "Course at General Assembly", shared: 0, employee_ids: [4] })
Event.create({ name: "What the Heck is Collection Select", date: "05/6/2019", category: "Tutorial", description: "Online tutorial", shared: 0, employee_ids: [5] })
Event.create({ name: "Personal website", date: "6/23/2019", category: "Other", description: "Rebuilt my personal website with React.js", shared: 1, employee_ids: [6] })
Event.create({ name: "Think Like a Computer Programmer", date: "6/28/2019", category: "Book", description: "A good book", shared: 1, employee_ids: [7] })
Event.create({ name: "San Diego Startup Week", date: "3/5/2019", category: "Conference Attendee", description: "Talk on quantum computing", shared: 1, employee_ids: [4] })
Event.create({ name: "Denver Devs Pizza + Code", date: "7/5/2019", category: "Meetup/Social", description: "We ate pizza and built and app", shared: 0, employee_ids: [5] })
